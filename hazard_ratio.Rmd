...
6% of the entire group that started treatment A, per year.
...
Put another way, the proportion of survivors dying each year for A is ...

```{python}
(1 - HR) * 100
```

... 58% lower than the proportion of survivors dying each year in treatment B.
