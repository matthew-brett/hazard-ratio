...
The *proportional hazards* assumption does not mean that we assume that the *hazard rates* are constant over time (as they are here); it means that the *hazard ratios* are constant over time.  In general, the hazard rate could vary over time, but the *hazard ratio* could still be constant - and the proportional hazards assumption assumes only that there is a constant hazard ratio.
